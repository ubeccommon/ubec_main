...
class UBECttProtocol:
    ...
    def assess_regeneration(self) -> Dict[str, Any]:
        ...
        """
        logger.info("Assessing regeneration principle for Fire element")
    ...
    def _sync_from_database(self):
        """Load transformation data from database"""
        if not self.db:
            return
        ...
        try:
            ...
            cursor.execute("""
                ...
                FROM ubec_transformative_actions
            ...
            cursor.execute("""
                ...
                FROM ubec_transformation_phases
