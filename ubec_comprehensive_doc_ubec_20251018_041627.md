...
**Database:** `ubec`  
**Host:** `localhost`  
**Generated:** 2025-10-18T04:16:26.690218  
...
|--------|-------------|--------|------|-------|------------|
| ubec_main | Main schema for UBEC four-element protoc... | 46 | 78,395 | 20 | 79 |
...
*Air element: Stellar liquidity pools containing UBEC family tokens. Tracks pool reserves, shares, and metadata for distribution compliance.*
