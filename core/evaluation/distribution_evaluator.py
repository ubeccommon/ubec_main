...
Changelog:
    v3.1.0 - MAJOR: Standardized health check using ServiceHealthCheck utility
           ...
           - Now uses ServiceHealthCheck.service_dependent_health()
...
class UBECDistributionEvaluator:
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        - Uses ServiceHealthCheck.service_dependent_health() for composite services
        ...
        return await ServiceHealthCheck.service_dependent_health(
...
if __name__ == "__main__":
    raise RuntimeError(
        ...
        "  await evaluator.close()\n\n"
        "Version 3.1.0 - Standardized Health Check Pattern:\n"
        "  - Uses ServiceHealthCheck.service_dependent_health() utility\n"
